...
public class RacingModeGameManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            //Then, destroy this. This enforces our singletton pattern,
            //meaning rhat there can only ever be one instance of a GameManager
            Destroy(gameObject);
    ...
    void Start()
    {
        ...
        //if photon network is ready, then
        //instaniate player selection according to their respective position 
        //based on join the game first second or third
